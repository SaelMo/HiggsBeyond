...
matrix2py.ml5_0_0_1_initialise(os.path.abspath(pjoin(root_path,os.pardir,os.pardir,'Cards','param_card.dat')))
...
finite_loop_me, return_code = matrix2py.ml5_0_0_1_get_me(P, alphas, renormalization_scale, nhel)


print '='*112
print '* %-108s *'%' MadLoop evaluation for the process '
print '* %-108s *'%'   g g > h h h WEIGHTED<=18 [ noborn = QCD ]'
