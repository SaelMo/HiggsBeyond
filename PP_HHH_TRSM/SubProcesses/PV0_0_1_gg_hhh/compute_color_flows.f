...
C     Storing concatenated filenames
      ...
      DATA (CONFIG_MAP(I),I=     1,     6) /     1,     2,     3,    
     $  0,     4,     5/
      DATA (CONFIG_MAP(I),I=     7,    12) /     6,     0,     7,    
     $  8,     9,     0/
      DATA (CONFIG_MAP(I),I=    13,    18) /    10,    11,    12,    
     $  0,    13,    14/
      DATA (CONFIG_MAP(I),I=    19,    24) /    15,     0,    16,   
     $  17,    18,     0/
      DATA (CONFIG_MAP(I),I=    25,    30) /    19,    20,    21,    
     $  0,    22,    23/
      DATA (CONFIG_MAP(I),I=    31,    36) /    24,     0,    25,   
     $  26,    27,     0/
      DATA (CONFIG_MAP(I),I=    37,    42) /     0,     0,     0,    
     $  1,     2,     3/
      DATA (CONFIG_MAP(I),I=    43,    48) /     0,     4,     5,    
     $  6,     0,     7/
      DATA (CONFIG_MAP(I),I=    49,    54) /     8,     9,     0,   
     $  10,    11,    12/
      DATA (CONFIG_MAP(I),I=    55,    60) /     0,    13,    14,   
     $  15,     0,    16/
      DATA (CONFIG_MAP(I),I=    61,    66) /    17,    18,     0,   
     $  19,    20,    21/
      DATA (CONFIG_MAP(I),I=    67,    72) /     0,    22,    23,   
     $  24,     0,    25/
      DATA (CONFIG_MAP(I),I=    73,    78) /    26,    27,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    79,    84) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    85,    90) /     1,     2,     3,    
     $  0,     0,     4/
      DATA (CONFIG_MAP(I),I=    91,    96) /     5,     6,     0,    
     $  0,     7,     8/
      DATA (CONFIG_MAP(I),I=    97,   102) /     9,     0,     0,   
     $  10,    11,    12/
      DATA (CONFIG_MAP(I),I=   103,   108) /     0,     0,    13,   
     $  14,    15,     0/
      DATA (CONFIG_MAP(I),I=   109,   114) /     0,    16,    17,   
     $  18,     0,     0/
      DATA (CONFIG_MAP(I),I=   115,   120) /    19,    20,    21,    
     $  0,     0,    22/
      DATA (CONFIG_MAP(I),I=   121,   126) /    23,    24,     0,    
     $  0,    25,    26/
      DATA (CONFIG_MAP(I),I=   127,   132) /    27,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   133,   138) /     1,     2,     3,    
     $  0,     0,     4/
      DATA (CONFIG_MAP(I),I=   139,   144) /     6,     5,     0,    
     $  0,     8,     9/
      DATA (CONFIG_MAP(I),I=   145,   150) /     7,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   151,   156) /     0,     0,     0,   
     $  10,    11,    12/
      DATA (CONFIG_MAP(I),I=   157,   162) /     0,     0,    13,   
     $  15,    14,     0/
      DATA (CONFIG_MAP(I),I=   163,   168) /     0,    17,    18,   
     $  16,     0,     0/
      DATA (CONFIG_MAP(I),I=   169,   174) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   175,   180) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   181,   186) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   187,   192) /    19,    20,    21,    
     $  0,     0,    22/
      DATA (CONFIG_MAP(I),I=   193,   198) /    24,    23,     0,    
     $  0,    26,    27/
      DATA (CONFIG_MAP(I),I=   199,   204) /    25,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   205,   210) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   211,   216) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   217,   222) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   223,   228) /     1,     2,     3,    
     $  0,     0,     4/
      DATA (CONFIG_MAP(I),I=   229,   234) /     5,     6,     0,    
     $  0,     7,     8/
      DATA (CONFIG_MAP(I),I=   235,   240) /     9,     0,     0,   
     $  10,    11,    12/
      DATA (CONFIG_MAP(I),I=   241,   246) /     0,     0,    13,   
     $  14,    15,     0/
      DATA (CONFIG_MAP(I),I=   247,   252) /     0,    16,    17,   
     $  18,     0,     0/
      DATA (CONFIG_MAP(I),I=   253,   258) /    19,    20,    21,    
     $  0,     0,    22/
      DATA (CONFIG_MAP(I),I=   259,   264) /    23,    24,     0,    
     $  0,    25,    26/
      DATA (CONFIG_MAP(I),I=   265,   270) /    27,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   271,   276) /     1,     2,     3,    
     $  0,     0,     4/
      DATA (CONFIG_MAP(I),I=   277,   282) /     6,     5,     0,    
     $  0,     8,     9/
      DATA (CONFIG_MAP(I),I=   283,   288) /     7,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   289,   294) /     0,     0,     0,   
     $  10,    11,    12/
      DATA (CONFIG_MAP(I),I=   295,   300) /     0,     0,    13,   
     $  15,    14,     0/
      DATA (CONFIG_MAP(I),I=   301,   306) /     0,    17,    18,   
     $  16,     0,     0/
      DATA (CONFIG_MAP(I),I=   307,   312) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   313,   318) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   319,   324) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   325,   330) /    19,    20,    21,    
     $  0,     0,    22/
      DATA (CONFIG_MAP(I),I=   331,   336) /    24,    23,     0,    
     $  0,    26,    27/
      DATA (CONFIG_MAP(I),I=   337,   342) /    25,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   343,   348) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   349,   354) /     0,     0,     0,    
     $  0,     0,     0/
...
C     
      ...
      DATA (CONFIG_INDEX_MAP(I),I=     1,     6) /     7,     8,     9
     $ ,    12,    13,    14/
      DATA (CONFIG_INDEX_MAP(I),I=     7,    12) /    17,    18,    19
     $ ,    22,    23,    24/
      DATA (CONFIG_INDEX_MAP(I),I=    13,    18) /    27,    28,    29
     $ ,    32,    33,    34/
      DATA (CONFIG_INDEX_MAP(I),I=    19,    24) /    37,    38,    39
     $ ,    42,    43,    44/
      DATA (CONFIG_INDEX_MAP(I),I=    25,    27) /    47,    48,    49/
C     
C     ARGUMENTS
C     
      INTEGER HEL_MULT
