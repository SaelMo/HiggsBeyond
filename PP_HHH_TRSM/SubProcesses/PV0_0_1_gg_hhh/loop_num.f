...
C      CALLS BUILDING THE LOOP
      ...
      SUBROUTINE ML5_0_0_1_LOOPNUM(Q,RES)
C     
C     CONSTANTS 
C     
      INTEGER    NLOOPGROUPS
...
C     
      ...
      CALL ML5_0_0_1_EVAL_POLY(LOOPCOEFS(0,ID),RANK,-Q,RES)
      END

      SUBROUTINE ML5_0_0_1_MPLOOPNUM(Q,RES)
C     
C     MODULE
C     
      INCLUDE 'cts_mprec.h'
...
C     
      LOGICAL MP_DONE
      COMMON/ML5_0_0_1_MP_DONE/MP_DONE
...
C      PURPOSE
      ...
      COMMON/ML5_0_0_1_MP_PSPOINT/MP_PS,MP_P
...
C     ----------
      ...
      CALL MP_ML5_0_0_1_EVAL_POLY(LOOPCOEFS(0,ID),RANK,-QQ,QRES)
      RES=QRES

      END

      SUBROUTINE ML5_0_0_1_MPLOOPNUM_DUMMY(Q,RES)
C     
C     MODULE
C     
      INCLUDE 'cts_mprec.h'
...
C     ----------
      ...
      CALL ML5_0_0_1_LOOPNUM(DQ,DRES)
      RES=DRES
